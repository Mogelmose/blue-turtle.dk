        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 md:gap-6 xl:gap-8 justify-items-center">
          {profiles.map((profile) => (
            <div
              ...
              className="flex flex-col items-center gap-2 p-3 md:p-6 rounded-2xl card shadow-md hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 cursor-pointer group"
            ...
            >
              ...
              <span className="font-bold text-base md:text-lg text-main text-center wrap-br w-full group-hover:text-primary transition-colors duration-300"> {}
                {profile.name}
              </span>
            </div>
          ))}
